...
var Network=pc.createScript("network");Network.id=null,Network.socket=null,Network.sphereOwner="",Network.timer=-1,Network.prototype.countstart=function(e=0){try{clearInterval(this.timeobj)}catch{}e&&(Network.timer=e),console.log(Number.timer,e),this.timeobj=setInterval((()=>{Network.timer--}),1e3)},Network.prototype.countstop=function(){try{clearInterval(this.timeobj)}catch{}},Network.prototype.updatePlayerDataText=function(){let e='<center><h1>Player Data</h1></center>\n  <div  style="background:rgba(200,200,200,0.2);padding:10px;border-radius: 5px;">\n    \n  \n<div style="background:rgba(255,104,66,0.7);padding:10px;border-radius: 5px;">\n<span style="font-size:30px;">Orange</span>\n  <hr>';for(let t in this.players){const o=this.players[t];"Orange"==o.team&&(e+=`<div  style="background:rgba(10,10,10,0.5);padding:10px;border-radius: 5px;display:flex;justify-content:space-between;font-size:20px"><span><strong>${o.name}</strong></span><span>\n  ${o.goals} Goal(s)\n  </span></div>`)}e+='\n</div>\n    <br>\n<div style="background:rgba(15,104,150,0.7);padding:10px;border-radius: 5px;">\n<span style="font-size:30px;">Blue</span>\n  <hr>';for(let t in this.players){const o=this.players[t];"Blue"==o.team&&(e+=`<div  style="background:rgba(10,10,10,0.5);padding:10px;border-radius: 5px;display:flex;justify-content:space-between;font-size:20px"><span><strong>${o.name}</strong></span><span>\n  ${o.goals} Goal(s)\n  </span></div>`)}e+="</div></div></div>";const t=document.getElementById("player-data");t&&(t.innerHTML=e)},Network.prototype.updateSphere=function(e){if(this.Sphere1){var t=new pc.Vec3(e.pos.x,e.pos.y,e.pos.z),o=new pc.Quat(e.rot.x,e.rot.y,e.rot.z,e.rot.w),i=new pc.Vec3(e.vel.x,e.vel.y,e.vel.z),r=new pc.Vec3(e.angVel.x,e.angVel.y,e.angVel.z);this.Sphere1.rigidbody.teleport(t,o),this.Sphere1.rigidbody.linearVelocity=i,this.Sphere1.rigidbody.angularVelocity=r}},Network.prototype.initialize=function(){this.player=this.app.root.findByName("Player1"),this.other=this.app.root.findByName("Player2"),this.Sphere1=this.app.root.findByName("Sphere1"),this.goalboxr=this.app.root.findByName("GoalBoxOr"),this.goalboxb=this.app.root.findByName("GoalBoxBlu"),this.scoreblue=this.app.root.findByName("ScoreBlue"),this.scoreorange=this.app.root.findByName("ScoreOrange"),this.orangebtn=this.app.root.findByName("Orange Button"),this.bluebtn=this.app.root.findByName("Blue Button"),this.loginscreen=this.app.root.findByName("Login Screen"),this.username=this.app.root.findByName("boxofinput"),this.orangegoal=this.app.root.findByName("OrangeGoalBanner"),this.bluegoal=this.app.root.findByName("BlueGoalBanner"),this.playernameo=this.app.root.findByName("playernameo"),this.playernameb=this.app.root.findByName("playernameb"),this.timemat=this.app.root.findByName("time"),this.spawnPoints={Orange:[this.app.root.findByName("SpawnO1"),this.app.root.findByName("SpawnO2")],Blue:[this.app.root.findByName("SpawnB1"),this.app.root.findByName("SpawnB2")]};var e=document.createElement("div");e.id="player-data",e.style.position="absolute",e.style.display="flex",e.style.color="white",e.style.top="50%",e.style.left="50%",e.style.fontFamily="sans-serif",e.style.background="rgba(0,0,0,0.5)",e.style.padding="10px",e.style.borderRadius="5px",e.style.zIndex="100",e.style.transform="translate(-50%, -50%)",e.style.flexDirection="column",e.style.width="40%",e.style.display="none",document.body.appendChild(e),this.app.on("tabdown",(()=>e.style.display="block")),this.app.on("tabup",(()=>e.style.display="none")),this.app.on("goalScored",this.resetRound1,this);var t=this;let o=this.app.root.findByName("boxofinput");this.orangebtn.button.on("click",(function(){console.log("Joining as",o.element.text.trim()),t.iniit(o.element.text.trim(),"Orange")})),this.bluebtn.button.on("click",(function(){t.iniit(o.element.text.trim(),"Blue")}));var i=io.connect("https://fresh-wary-cupcake.glitch.me/");Network.socket=i,i.on("timer",(function(e){console.log(e.time),t.countstart(Number(e.time)),t.fire("goalScored")})),i.on("pause",(function(e){t.countstop()})),i.on("updateSphere",(function(e){t.updateSphere(e)})),i.on("playerData",(function(e){t.initializePlayers(e)})),i.on("playerJoined",(function(e){t.addPlayer(e)})),i.on("playerMoved",(function(e){t.movePlayer(e)})),i.on("spherowner",(function(e){console.log(e.id),Network.sphereOwner=e.id})),i.on("killPlayer",(function(e){t.removePlayer(e)})),i.on("scoreupdate",(function(e){console.log("score",e),t.scoreup(e)})),this.player.collision.on("collisionstart",this.onCollisionStart,this),this.goalboxr.collision.on("triggerenter",this.onCollisionStartB,this),this.goalboxb.collision.on("triggerenter",this.onCollisionStartG,this),this.players={},this.initialized=!1,this.sphereUpdateTimer=0},Network.prototype.iniit=function(e,t){""!=e&&(Network.socket.emit("initialize",{name:e,team:t}),this.loginscreen.enabled=!1)},Network.prototype.scoreup=function(e){console.log("score",e),this.initializePlayers,this.scoreblue.element.text!=String(e.b)?(this.bluegoal.enabled=!0,this.playernameb.element.text=e.scorer,setTimeout((()=>this.bluegoal.enabled=!1),5e3)):this.scoreorange.element.text!=String(e.o)&&(this.orangegoal.enabled=!0,this.playernameo.element.text=e.scorer,setTimeout((()=>this.orangegoal.enabled=!1),5e3)),e.now?this.app.fire("goalScored"):setTimeout((()=>this.app.fire("goalScored")),5e3),this.scoreblue.element.text=String(e.b),this.scoreorange.element.text=String(e.o),console.log(this.scoreblue,this.scoreorange)},Network.prototype.onCollisionStart=function(e){e.other&&"Sphere1"===e.other.name&&(console.log("Player touched the sphere!"),this.takeSphereOwnership())},Network.prototype.onCollisionStartG=function(e){console.log("illkms",e.name),"Sphere1"===e.name&&(console.log("Orange"),this.goal("Orange"),this.Sphere1.rigidbody.enabled=!1)},Network.prototype.onCollisionStartB=function(e){console.log("illkms",e.name),"Sphere1"===e.name&&(console.log("Blue"),this.goal("Blue"),this.Sphere1.rigidbody.enabled=!1)},Network.prototype.initializePlayers=function(e){for(var t in this.players=e.players,Network.id=e.id,this.players)if(t!==Network.id)this.players[t].entity=this.createPlayerEntity(this.players[t]);else if(this.player.rigidbody.teleport(this.players[t].x,this.players[t].y,this.players[t].z),this.player&&this.Sphere1&&"Orange"==this.players[t]){var o=new pc.Quat;o.setFromEulerAngles(0,180,0),this.players[t].targetRot=o}this.initialized=!0},Network.prototype.spwnplayers=function(){for(var e in Network.id=data.id,this.players)this.player.rigidbody.teleport(this.players[e].x,this.players[e].y,this.players[e].z);this.initialized=!0},Network.prototype.addPlayer=function(e){this.players[e.id]=e,this.players[e.id].entity=this.createPlayerEntity(e)},Network.prototype.movePlayer=function(e){if(this.initialized&&!this.players[e.id].deleted){this.players[e.id].targetPos=new pc.Vec3(e.x,e.y,e.z);var t=new pc.Quat;t.setFromEulerAngles(e.face.x,e.face.y,e.face.z),this.players[e.id].targetRot=t}},Network.prototype.removePlayer=function(e){this.players[e]&&this.players[e].entity&&(this.players[e].entity.destroy(),this.players[e].deleted=!0)},Network.prototype.createPlayerEntity=function(e){var t=this.other.clone();return t.enabled=!0,this.other.getParent().addChild(t),e&&t.rigidbody.teleport(e.x,e.y,e.z),t},Network.prototype.update=function(e){if(0==Network.timer&&(this.countstop(),Number(this.scoreblue.element.text)>Number(this.scoreorange.element.text)?(this.bluegoal.enabled=!0,this.playernameb.element.text="Blue Won",setTimeout((()=>this.bluegoal.enabled=!1),5e3)):Number(this.scoreblue.element.text)<Number(this.scoreorange.element.text)?(this.orangegoal.enabled=!0,this.playernameo.element.text="Orange Won",setTimeout((()=>this.orangegoal.enabled=!1),5e3)):(this.orangegoal.enabled=!0,this.playernameo.element.text="Tie",setTimeout((()=>this.orangegoal.enabled=!1),5e3))),this.timemat.element.text=String(Math.floor(Network.timer/60)+":"+Network.timer%60),this.initialized){this.updatePosition(),this.updatePlayerDataText(),this.sphereUpdateTimer+=e;var t=this.Sphere1.rigidbody;for(var o in console.log(Network.sphereOwner),Network.sphereOwner==Network.id&&Network.socket.emit("spherePositionUpdate",{id:Network.id,pos:{x:t.entity.getPosition().x,y:t.entity.getPosition().y,z:t.entity.getPosition().z},rot:{x:t.entity.getRotation().x,y:t.entity.getRotation().y,z:t.entity.getRotation().z,w:t.entity.getRotation().w},vel:{x:t.linearVelocity.x,y:t.linearVelocity.y,z:t.linearVelocity.z},angVel:{x:t.angularVelocity.x,y:t.angularVelocity.y,z:t.angularVelocity.z}}),this.players)if(o!==Network.id&&!this.players[o].deleted){var i=this.players[o],r=i.entity;if(i.targetPos&&i.targetRot){var n=r.getPosition();n.lerp(n,i.targetPos,.2);var a=r.getRotation();a.slerp(a,i.targetRot,.2),r.rigidbody.teleport(n,a)}}}},Network.prototype.updatePosition=function(){var e=this.player.getPosition(),t=this.player.getEulerAngles();Network.socket.emit("positionUpdate",{id:Network.id,x:e.x,y:e.y,z:e.z,face:t})},Network.prototype.takeSphereOwnership=function(){Network.socket&&(console.log("sen"),Network.socket.emit("claimSphere",{id:Network.id}))},Network.prototype.goal=function(e){Network.socket&&(console.log("sent"),Network.socket.emit("Goal",{name:e}),Network.socket.emit("score",{name:e}))},Network.prototype.resetRound1=function(){this.resetRound(),setTimeout((()=>this.resetRound()),200)},Network.prototype.resetRound=function(){this.Sphere1.rigidbody.enabled=!0,this.Sphere1.rigidbody.teleport(0,10,0),this.Sphere1.rigidbody.linearVelocity=pc.Vec3.ZERO,this.Sphere1.rigidbody.angularVelocity=pc.Vec3.ZERO,this.player.rigidbody.linearVelocity=pc.Vec3.ZERO.clone(),this.player.rigidbody.angularVelocity=pc.Vec3.ZERO.clone();var e=this.players[Network.id].x,t=new pc.Vec3(e,0,0);this.player.lookAt(0,0,0),this.player.rotateLocal(0,180,0),this.player.lookAt(0,0,0),this.player.rotateLocal(0,180,0),this.player.rigidbody.teleport(t)};var UiScore=pc.createScript("uiScore");UiScore.prototype.initialize=function(){},UiScore.prototype.update=function(i){};var UiInputField=pc.createScript("uiInputField");UiInputField.attributes.add("textEntity",{type:"entity",title:"Text Entity",description:"The Entity that has the text Element to update with the inputted text."}),UiInputField.attributes.add("inputType",{type:"string",title:"Input Type",description:"What type of input will this field accept. On some devices, the virtual keyboard layout may change as well. For example, 'Number' will bring up a numpad instead of the full keyboard.",default:"text",enum:[{Text:"text"},{"Text (no spellcheck)":"text no spellcheck"},{Email:"email"},{Number:"number"},{Decimal:"decimal"},{Password:"password"}]}),UiInputField.attributes.add("enterKeyHint",{type:"string",title:"Enter Key Hint",description:"Change what the enter key shows on the virutal keyboard. Different OSs will have different representations of the hint.",default:"enter",enum:[{Enter:"enter"},{Done:"done"},{Go:"go"},{Search:"search"},{Send:"send"}]}),UiInputField.attributes.add("maxLength",{type:"number",default:32,title:"Max Length",description:"Maximum length of the text can be."}),UiInputField.attributes.add("placeHolder",{type:"string",default:"Placeholder text...",title:"Place Holder String",description:"When the inputted text is empty, what should show as placeholder? Usually this is a prompt such as 'Enter your email here'."}),UiInputField.attributes.add("placeHolderColor",{type:"rgb",title:"Place Holder Text Color",description:"What color the text should be when the placeholder string is used."}),UiInputField.prototype.initialize=function(){this._textElement=this.textEntity.element,this._textColor=this._textElement.color.clone(),this.value="",this.setEvents("on"),this.on("destroy",(()=>{this.setEvents("off")})),this._onValueChange("")},UiInputField.prototype.setEvents=function(t){this.entity[t]("uiinput:updatevalue",this._onValueChange,this),this.entity.element[t]("click",this._onClick,this)},UiInputField.prototype._onValueChange=function(t){if(this.value=t,t.length>0){if("password"===this.inputType){let e="";for(let i=0;i<t.length;++i)e+="*";this._textElement.text=e}else this._textElement.text=t;this._textElement.color=this._textColor}else this._textElement.text=this.placeHolder,this._textElement.color=this.placeHolderColor;this.entity.fire("updatedvalue",t)},UiInputField.prototype._onClick=function(t){this.app.fire("uiinput:clicked",this,t)};!function(){const e=function getIosVersion(){if(/iP(hone|od|ad)/.test(navigator.platform)){var e=navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/);return[parseInt(e[1],10),parseInt(e[2],10),parseInt(e[3]||0,10)]}return null}();document.documentElement.style.setProperty("--sat","env(safe-area-inset-top)"),document.documentElement.style.setProperty("--sab","env(safe-area-inset-bottom)"),document.documentElement.style.setProperty("--sal","env(safe-area-inset-left)"),document.documentElement.style.setProperty("--sar","env(safe-area-inset-right)");const t=pc.Application.getApplication();let n=null;function createInputDom(){n&&n.remove(),n=document.createElement("input"),n.setAttribute("type","text"),n.style.position="absolute",n.style.fontFamily="Arial, sans-serif",n.style.background="white",n.style.paddingLeft="10px",n.style.paddingRight="10px",n.style.margin="0px",n.style.visibility="hidden",n.style.zIndex=1e3,resetStyle(),n.value="",document.body.appendChild(n)}createInputDom();let i=!1,o=!1,l=null;function onInputFieldClick(e,t){t.stopPropagation(),function showDom(e,t){if(o===e)return;o&&o!==e&&onBlur();o=e,"visible"!==n.style.visibility&&(t.changedTouches?(t.event.preventDefault(),i=!1):i=!0,n.style.visibility="visible",n.onblur=onBlur,n.addEventListener("keydown",onKeyDown),n.addEventListener("keyup",onKeyUp));switch(n.value=e.value,n.maxLength=e.maxLength,n.placeholder=e.placeHolder,n.pattern=null,n.spellcheck=!1,e.inputType){case"text":default:n.type="text",n.spellcheck=!0;break;case"text no spellcheck":n.type="text";break;case"number":n.type="number",n.pattern="[0-9]*";break;case"decimal":n.type="number";break;case"email":n.type="email";break;case"password":n.type="password"}n.enterKeyHint=e.enterKeyHint,n.focus(),updateStyle(),o.entity.element.on("resize",updateStyle)}(e,t)}function onBlur(){n.onblur=null,n.removeEventListener("keydown",onKeyDown),n.removeEventListener("keyup",onKeyUp),n.style.visibility="hidden",function onElementSwitch(){o.entity.fire("uiinput:updatevalue",n.value),o.entity.element.off("resize",updateStyle),"password"===o.inputType&&createInputDom(),o=null}()}function onKeyDown(e){e.stopPropagation()}function onKeyUp(e){e.preventDefault(),e.stopPropagation(),13===e.keyCode&&n.blur()}function resetStyle(){const e=parseInt(getComputedStyle(document.documentElement).getPropertyValue("--sal")),t=parseInt(getComputedStyle(document.documentElement).getPropertyValue("--sar"));n.style.left="20px",n.style.height="40px",n.style.width=window.innerWidth-64-e-t+"px",n.style.fontSize="100%",n.style.top="20px",n.style.marginTop="env(safe-area-inset-top)",n.style.marginLeft="env(safe-area-inset-left)",n.style.bottom=null}function updateStyle(){if(o)if(i&&o.entity.element.screenCorners){const e=o.entity.element.screenCorners,i=Math.min(t.graphicsDevice.maxPixelRatio,window.devicePixelRatio);n.style.left=e[0].x/i-2+"px",n.style.bottom=e[0].y/i-2+"px",n.style.top=null;const l=(e[2].x-e[0].x)/i-20,s=(e[2].y-e[0].y)/i;n.style.width=l+"px",n.style.height=s+"px",n.style.fontSize=Math.round(.5*s)+"px"}else resetStyle()}function onIosResizeTimeout(){t.on("uiinput:clicked",onInputFieldClick),l=null}e?l=setTimeout(onIosResizeTimeout,2100):t.on("uiinput:clicked",onInputFieldClick),t.graphicsDevice.on("resizecanvas",(function onResize(){e&&!l&&(t.off("uiinput:clicked",onInputFieldClick),l=setTimeout(onIosResizeTimeout,2100)),setTimeout((()=>{updateStyle()}))}))}();var WaterShader=pc.createScript("water");WaterShader.attributes.add("speed",{type:"number",default:1}),WaterShader.attributes.add("amplitude",{type:"number",default:.05}),WaterShader.prototype.initialize=function(){var e=this.app.graphicsDevice,i=`\n        precision mediump float;\n\n        uniform float uTime;\n        varying vec2 vUv;\n\n        void main(void) {\n            float wave = sin(vUv.x * 15.0 + uTime) * ${this.amplitude.toFixed(2)} +\n                         cos(vUv.y * 20.0 + uTime * 0.5) * ${this.amplitude.toFixed(2)};\n            \n            vec3 baseColor = vec3(0.0, 0.4, 0.7);\n            vec3 color = baseColor + vec3(wave * 0.5, wave * 0.4, wave);\n\n            gl_FragColor = vec4(color, 1.0);\n        }\n    `;this.shaderDefinition={attributes:{aPosition:pc.SEMANTIC_POSITION,aUv0:pc.SEMANTIC_TEXCOORD0},uniforms:{uTime:pc.UNIFORMTYPE_FLOAT},vshader:"\n        attribute vec3 aPosition;\n        attribute vec2 aUv0;\n\n        varying vec2 vUv;\n\n        uniform mat4 matrix_model;\n        uniform mat4 matrix_viewProjection;\n\n        void main(void) {\n            vUv = aUv0;\n            gl_Position = matrix_viewProjection * matrix_model * vec4(aPosition, 1.0);\n        }\n    ",fshader:i},this.shader=new pc.Shader(e,this.shaderDefinition),this.material=new pc.Material,this.material.shader=this.shader,this.material.update(),this.entity.model.meshInstances[0].material=this.material,this.time=0},WaterShader.prototype.update=function(e){this.time+=e*this.speed,this.material.setParameter("uTime",this.time)};